...
{
	/// <summary>
	/// Evento che segnala la pressione del pulsante sinistro del mouse
	/// </summary>
	public class LeftMouseButtonDown : AutomaEvent
	{
		/// <summary>
		...
		public LeftMouseButtonDown(Int32 positionX, Int32 positionY)
		{
