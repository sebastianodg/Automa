...
{
	/// <summary>
	/// Evento che segnala il rilascio del pulsante destro del mouse
	/// </summary>
	public class RightMouseButtonUp : AutomaEvent
	{
		/// <summary>
		...
		public RightMouseButtonUp(Int32 positionX, Int32 positionY)
		{
