...
{
	/// <summary>
	/// Evento che segnala la pressione del pulsante centrale del mouse
	/// </summary>
	public class MidMouseButtonDown : AutomaEvent
	{
		/// <summary>
		...
		public MidMouseButtonDown(Int32 positionX, Int32 positionY)
		{
