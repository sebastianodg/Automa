...
{
	/// <summary>
	/// Evento che segnala la pressione del pulsante destro del mouse
	/// </summary>
	public class RightMouseButtonDown : AutomaEvent
	{
		/// <summary>
		...
		public RightMouseButtonDown(Int32 positionX, Int32 positionY)
		{
