...
{
	/// <summary>
	/// Evento che segnala il rilascio del pulsante sinistro del mouse
	/// </summary>
	public class LeftMouseButtonUp : AutomaEvent
	{
		/// <summary>
		...
		public LeftMouseButtonUp(Int32 positionX, Int32 positionY)
		{
